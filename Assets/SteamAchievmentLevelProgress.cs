...
public class SteamAchievmentLevelProgress : MonoBehaviour 
{

    public int whatAchievment;
    ...
    {
        // Test if Steam is initialized
        if (SteamManager.Initialized)
        {
            Debug.Log("Hazaa!");
            UnlockAchievement(m_Achievements[whatAchievment]);
